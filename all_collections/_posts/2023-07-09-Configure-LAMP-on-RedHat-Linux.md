...
**Note : The scope of this LAMP configuration is RedHat Linux. The command or path of the file might be vary depending on Linux distribution (Linux distro) that you are using. Other Linux distro such as Ubuntu, might have different path of *php.ini* file. This configuration guide will assume that you are familiar with basic Linux command and have a basic understanding of dynamic website.**
